...
public class CustomRecyclerView extends RecyclerView {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        int dy = this.getChildAt(0).getHeight();
        View focusView = this.getFocusedChild();
        if (focusView != null) {
            //处理左右方向键移动Item到边之后RecyclerView跟着移动
            switch (event.getKeyCode()) {
                case KeyEvent.KEYCODE_DPAD_RIGHT:
                    Log.i("wlx", "CustomRecyclerView.KEYCODE_DPAD_RIGHT.");
                    if (event.getAction() == KeyEvent.ACTION_UP) {
                        return true;
                    } else {
                        View rightView = FocusFinder.getInstance().findNextFocus(this, focusView, View.FOCUS_RIGHT);
                        Log.i("wlx", "rightView is null:" + (rightView == null));
                        if (rightView != null) {
                            Log.i("wlx", "CustomRecyclerView.requestFocusFromTouch.");
                ...
                case KeyEvent.KEYCODE_DPAD_LEFT:
                    ...
                    Log.i("wlx", "left is null:" + (leftView == null));
                    if (event.getAction() == KeyEvent.ACTION_UP) {
                        return true;
                    } else {
                        if (leftView != null) {
                ...
                case KeyEvent.KEYCODE_DPAD_UP://上
                    ...
                    Log.i("wlx", "up is null:" + (upView == null));
                    if (event.getAction() == KeyEvent.ACTION_UP) {
                        return true;
                    } else {
                        if (upView != null) {
                ...
                case KeyEvent.KEYCODE_DPAD_DOWN://下
                    View dowView = FocusFinder.getInstance().findNextFocus(this, focusView, View.FOCUS_DOWN);
                    Log.i("wlx", "down is null:" + (dowView == null));
                    if (event.getAction() == KeyEvent.ACTION_UP) {
                        return true;
                    } else {
                        if (dowView != null) {
                            dowView.requestFocusFromTouch();
                            return true;
                        } else {
                            this.smoothScrollBy(0, dy);
                            return true;
    ...
    public void onScrolled(int dx, int dy) {
        Log.i("wlx", "CustomRecyclerView.onScrolled.");
        ...
        if (focusView != null) {
            if (dx > 0) {
                ...
                View rightView = FocusFinder.getInstance().findNextFocus(this, focusView, View.FOCUS_DOWN);
                if (rightView != null) {
                    rightView.requestFocusFromTouch();
                }

            } else if (dy < 0) {
                View rightView = FocusFinder.getInstance().findNextFocus(this, focusView, View.FOCUS_UP);
                if (rightView != null) {
                    rightView.requestFocusFromTouch();
                }
    ...
    public boolean isLastItemVisible(int lineNum, int allItemNum) {
        ...
        if (layoutManager instanceof StaggeredGridLayoutManager) {
            ...
            Log.i("wlx", "lastVisiblePosition:" + position);
