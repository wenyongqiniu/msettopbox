 ...
 */
package com.yxws.tvwidget.view;
...
import com.yxws.tvwidget.R;
import com.yxws.tvwidget.bridge.BaseEffectBridge;
...
public class MainUpView extends FrameLayout {
     ...
     * @param scale   放大的比例, 可以设置为1.1f, 1.1f或者其它
     */
    ...
    public void setEffectBridge(BaseEffectBridge effectBridge) {
        if (effectBridge != null) {
            ...
            this.mEffectBridge = new OpenEffectBridge();
        }
        if (this.mEffectBridge != null) {
